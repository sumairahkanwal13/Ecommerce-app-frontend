  ...
  return (
    <div className="container text-center my-5">
      <div className="card p-5 shadow-lg">
        ...
        <p>Thank you for shopping with <strong>Fashion 21</strong>.</p>
      ...
      <div className="mt-5 text-start mx-auto" style={{ maxWidth: "600px" }}>
        ...
        <h5 className="text-end mt-3">
          Total: <span className="text-success">${lastOrder.total.toFixed(2)}</span>
        </h5>
